...
//var city = "Bangalore"
//var fooditem = "pavbhaji"
//var snacks = "panipuri"
//var TV = "sumsung"
//var quote = "hardwork beats talent"
...
function mother(emotion,caring)
{
	var salary = "5lakhs"
	console.log(emotion,caring,salary)
}
mother("happiness","always she want u to be happy")

function bdata(strength,emotion)
{
	var hadurbrkfst = "yes"
	console.log(strength,emotion,hadurbrkfst)
}
bdata("helpful","care")

function InfoC(companyname,designation,salary)
{
	var location = "hyderabad"
	console.log(companyname,designation,salary,location)
}
InfoC("JC","programmer","3.2 or 320000")

function emertxe(company,fees)
{
	var classtime = "8.30am"
	console.log(company,fees,classtime)
}
emertxe("IT",35000)
...
var sundarpichai = new ceo()
console.log(sundarpichai.name)
//------------------------------------------------------------------
class humans{
	emotion = "happiness"
constructor()
...
var venkatesh = new humans()
//-----------------------------------------------------------------
class inventor{
constructor(langcreator){
//document.writeln("inventor constructor")
	this.c = langcreator
	console.log(this.c)
}
}
new inventor ("dennis ritchie")
//----------------------------------------------------------------
class company{
	companyname = "JVT"
...
var jvt = new company()
console.log(jvt.companyname,jvt.desgination,jvt.salary,jvt.location)
//-----------------------------------------------------------------
class details{
